      ...
      <main className="pt-32">
        <section className="py-20 px-6">
          <div className="max-w-7xl mx-auto">
            <h1 className="text-5xl font-bold mb-6 text-center">Build My Website</h1>
            <p className="text-xl text-muted text-center max-w-3xl mx-auto mb-16">
              Answer a few questions, share your logo and photos, and preview your homepage before paying the balance.
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-12">
              ...
              <div className="glass p-8 rounded-lg">
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <button type="submit" className="w-full bg-accent px-6 py-4 rounded-lg hover:bg-brand-navy transition-all font-semibold hover:scale-105 hover:shadow-2xl hover:shadow-accent/50">
                    Preview My Website
                  </button>
                </form>
              </div>
              ...
              <div className="space-y-8">
                ...
                <div className="glass glass-hover p-6 rounded-lg transition-all">
                  ...
                  <a
                    href="https://wa.me/YOUR_PHONE_NUMBER?text=Hi%20Valaiyam,%20I%27d%20like%20to%20build%20my%20website"
                    target="_blank"
