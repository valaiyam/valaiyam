            ...
            <div className="grid md:grid-cols-2 gap-12">
              ...
              <div>
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <button type="submit" className="w-full bg-accent px-6 py-4 rounded-lg hover:bg-blue-600 transition font-semibold">
                    Send Message
                  </button>
                </form>
              </div>
              ...
              <div className="space-y-8">
                ...
                <div className="border border-white/10 p-6 rounded-lg">
                  ...
                  <a
                    ...
                    className="flex items-center gap-3 bg-green-500 hover:bg-green-600 px-6 py-3 rounded-lg transition"
                  >
