    ...
    <footer className="glass border-t border-default py-12">
      <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <Link href="/contact" className="inline-block bg-accent px-6 py-2 rounded-lg hover:bg-blue-600 transition text-sm hover:scale-105 hover:shadow-lg hover:shadow-accent/50 text-white">
